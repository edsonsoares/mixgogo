  ...
  Set.find( 
    {
      'dateEvent':
        {
          $gte: moment().startOf('day').subtract(250, 'days').toDate()
        }
...
router.get('/api/get/:id', function(req, res){
  ...
  Set.findById(requestedId, function(err,data){
    ...
    // Format event's date with Momentjs 
    var eventDate = data.dateEvent;
    var dateEvent = moment(eventDate).format('ddd D MMM');
    // console.log('this event happens on:');
    // console.log(eventDate);
    // console.log('Date after formating:');
